...
const CategoryScreen = () => {
  ...
  if (params.cat && params.cat !== 'All' && location == '/product/category/' + params.cat) {
    filteredProducts = products.filter((product) => product.tags.includes(params.cat));
  } 
  else if (params.cat && params.cat !== 'All') {
    filteredProducts = products.filter((product) => product.tags.includes(params.cat) && product.tags.includes(clickedNavLink));
  } 
  else if (params.cat && params.cat == 'All' && location !== '/product/category/' + params.cat) {
    console.log("Hello");
    filteredProducts = products.filter((product) => product.tags.includes(clickedNavLink));
  } 
  else if (params.cat && params.cat == 'All' && location == '/product/category/' + params.cat) {
